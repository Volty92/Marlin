...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //<VOLTY>
  #define  DEFAULT_bedKp 124.51
  #define  DEFAULT_bedKi 14.34
  #define  DEFAULT_bedKd 270.29
  //<VOLTY>
...
//FAU
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.165, 80.165, 399.2901, 401 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the boundaries for probing (where the probe can reach). //FAU
